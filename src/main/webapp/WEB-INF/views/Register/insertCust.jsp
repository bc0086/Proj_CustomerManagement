...
<div class="container-sm">
	...
	<div class="row justify-content-around">
		<div class="col-4">
			...
			<input type="text" value="1" name="custNo" id="custNo" style="margin-left: 11px;" readonly="readonly" />
		</div>
		
		<div class="col-8" >
			<span class="badge badge-info" style="font-size:17px; width:100px;">분류</span>
			<select style="margin-left: 11px; width: 70px;">
	...
	<div>
		...
		<input type="date" style="margin-left:11px; text-align: center; width:182px;"  />
	</div>
	...
	<div>
		...
		<input type="text" style="margin-left:11px; width:550px;" />
	</div>
	
	<div>
		<span class="badge badge-info" style="font-size:17px; width:100px; margin-top: 10px;">홈페이지</span>
		<input type="email" style="margin-left:11px; width:550px;" />
	</div><br />
	...
	<div class="row">
		...
		<div class="col-11">
			<input type="text" style="margin-left:20px; width: 1010px; height:200px; margin-top: 10px;"/>
		</div>
	</div><br />
	...
	<div class="row justify-content-around">
		...
		<div class="col-7" >
			...
			<input type="text" style="margin-left: 11px; width:300px;" readonly="readonly">
		</div>
	</div>
</div>
</form>
